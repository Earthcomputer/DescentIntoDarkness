...
public final class ReplaceCeilingStep extends PainterStep {
    ...
    private ReplaceCeilingStep(List<String> tags, boolean tagsInverted, BlockPredicate old, BlockStateProvider _new, double chance) {
